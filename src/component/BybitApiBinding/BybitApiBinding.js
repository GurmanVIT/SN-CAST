...
const BybitApiBinding = () => {
  ...
  const onBindClick = () => {
    if (bybitApiKey.length == 0) {
      alert("Please enter Api Key");
    } else if (bybitSecretKey.length == 0) {
                ...
                <div className="card-custom">
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="">
                        <p>
                          For security, Bybit Exchange recommends binding the
...
export default BybitApiBinding;
