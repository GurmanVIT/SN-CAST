...
const ApiBinding = () => {
    ...
    const updateProfileSuccess = useSelector((state) => state.updateProfileReducer.data);
                    ...
                    <div className="bottom-content">
                                        ...
                                        <div className="col">
                                            <div className="">
                                                <div className="form-group  input-ip-cuatom">
                                                    ...
                                                    <p className="form-control form-control-cus">435.864.543.12</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col">
                                <div className="card-custom">
                                    <div className="row">
                                        ...
                                        <div className="col-8">
                                            <div className="form-group">
                                                <input type="text" placeholder="Api Key" className="form-control form-control-cus"
                                                    disabled={!disabled}
                                                    value={apiKey}
                                                    onChange={(e) => {
                                                        handleApiKey(e);
                                    ...
                                    <div className="row mt-3">
                                        ...
                                        <div className="col-8">
                                            <div className="form-group">
                                                <input type="password" placeholder="*********" className="form-control form-control-cus"
                                                    disabled={!disabled}
                                                    value={secretKey}
                                                    onChange={(e) => {
                        ...
                        {disabled ?
                            <div className="row mt-4">
                                <div className="col">
                                    <button type="button" className="replace-btn" onClick={() => onBindClick()}>Bind</button>
                                </div>
                            </div>
                            ...
                            <div className="row mt-4">
                                <div className="col">
                                    <button type="button" className="replace-btn" onClick={() => setDisabled(true)}>Replace</button>
                                </div>
                                <div className="col">
